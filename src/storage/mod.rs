...
pub use buffer::{OxicodeObjectBuffer, Storage};

use crate::ldap::LdapSearchEntry;
pub use iter::DiskStorageReader;

pub type DiskStorage = OxicodeObjectBuffer<LdapSearchEntry>;

/// Used to iterate over LDAP search entries.
///
// trait is required because OxicodeFileIterator will return a Result(LdapSearchEntry, Box<dyn Error>)
